...
public:
    ...
    void inorderOfFirst(TreeNode* node1,vector<int>& in1){
        if(node1==NULL) return;
        inorderOfFirst(node1->left,in1);
        in1.push_back(node1->val);
        inorderOfFirst(node1->right,in1);
    }
    ...
    vector<int> getAllElements(TreeNode* root1, TreeNode* root2) {
        ...
        inorderOfFirst(root1,in1);
        inorderOfSecond(root2,in2);
